...
import StrapiEntryPlugin from './plugins/StrapiEntryPlugin';
import './styles.css';
...
export default function Editor(props: LexicalEditorProps): JSX.Element {
  ...
  return (
    <>
      ...
      <StrapiOnChangePlugin 
        onChange={(data) => onChange(data.editorState)} 
        expectedEditorState={props.expectedEditorState} 
        enableReferences={props.enablePopulate || false}
      />
      <StrapiImagePlugin />
      <StrapiEntryPlugin />
    </>
