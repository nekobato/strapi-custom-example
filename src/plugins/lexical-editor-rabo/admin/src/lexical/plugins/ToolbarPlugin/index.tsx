...
import { INSERT_STRAPI_ENTRY_COMMAND } from '../StrapiEntryPlugin';
import { InsertTableDialog } from '../TablePlugin';
import StrapiEntryModal from '../../../components/StrapiEntryModal';
import {
  clearFormatting,
  formatBulletList,
  formatCheckList,
        ...
        <>
          ...
          <button
            onClick={() => {
              showModal(
                formatMessage({
                  id: 'lexical.plugin.toolbar.insert.strapientry.title',
                ...
                (onClose) => (
                  <StrapiEntryModal
                    ...
                    setOpen={() => onClose()}
                    onSelectEntry={(entry) => {
                      activeEditor.dispatchCommand(INSERT_STRAPI_ENTRY_COMMAND, {
            ...
            title={formatMessage({
              id: 'lexical.plugin.toolbar.insert.strapientry.title',
              defaultMessage: 'Strapi Entry',
            })}
            type="button"
            className="toolbar-item"
            aria-label={formatMessage({
              id: 'lexical.plugin.toolbar.insert.strapientry.aria',
              defaultMessage: 'Insert Strapi Entry',
            })}
          >
            <i className="format link" />
